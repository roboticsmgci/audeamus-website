  ...
  return (
    <div className="grid grid-cols-4">
      <main className="col-span-3">
        ...
        <p className="text-center text-3xl mt-4 mb-8 mx-5">
        ...
        <div className="grid grid-cols-3 my-10">
          <div className="col-span-2">
            <h3 className={classNames('text-4xl font-bold italic text-center', styles.textShadow)}>Wanna join?</h3>
        ...
        <div className="grid grid-cols-3">
          <div className="col-span-2">
            <h3 className={classNames('text-4xl font-bold italic text-center', styles.textShadow)}>Competition History</h3>
            <p className="text-2xl mx-auto max-w-md">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum molestie
              dapibus nibh, nec molestie mi semper nec. Integer interdum congue lorem, sit amet
              sagittis eros tempor quis.
      ...
      <div className="border-l-2 bg-[#313137] px-3">
